...
public class ImmersiveBars {
     ...
     * For usage in the React Module
     */
    public static void setTranslucentBarColor(final Activity activity, final Boolean isDarkMode, final String translucentLightStr, final String translucentDarkStr) {
        if (activity == null) {
            return;
        }
        final Window window = activity.getWindow();
